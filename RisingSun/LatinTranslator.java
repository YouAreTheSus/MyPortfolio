...
public class LatinTranslator extends WindowController
{
    ...
    public LatinTranslator()
    {
        ...
        Text label = new Text("Translating 111 among us imposter sussy 111:",0,0,canvas);
        Text response = new Text(Translate("111 among us imposter sussy 111"),0,20,canvas);
    }
